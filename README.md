...
| -------------------- | ------------------------------------------------ | ----------------------------------------------------------------------------------------------- |
| `model-tier-policy`  | [1.9.2](plugins/model-tier-policy/CHANGELOG.md)  | The tier-policy skill, eleven pinned-model agents, and the three hooks with their reminder text |
