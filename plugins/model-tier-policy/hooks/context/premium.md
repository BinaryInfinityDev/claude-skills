...
- "{steward}" ({steward_model}) is resident, named steward — spawn it first if it is not in your roster: commit your
  plan, tracker, decision, and review files by messaging it `commit <path>: <subject>`, one line, rather than leaving
