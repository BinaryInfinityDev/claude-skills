...
- **Added:** the plugin form of `ingest-artifact` and `record-decision`, unchanged in content from the unpackaged
  skills.

## Before packaging

- 2026-05-25 — `ingest-artifact` pinned to Haiku as a procedural skill.
- 2026-05-24 — the initial commit: `ingest-artifact` and `record-decision`.
