...
check("orch SendMessage to the resident steward allowed", decision(guard(orch, tr_o, "SendMessage", {"to": "steward", "message": "commit .claude/build-timings.md: Record bar run"})), None)
check("premium SendMessage to the resident steward allowed", decision(guard(premium, tr_p, "SendMessage", {"to": "steward", "message": "commit .claude/plans/p.plan.md: Amend plan"})), None)
